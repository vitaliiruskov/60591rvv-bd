    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-primary">
        ...
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="https://i.ibb.co/hFNXqFq/logohotelwhite.png" alt="" width="30" height="24" class="d-inline-block align-text-top">
                HOTEL
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                if (!$data['user'])
                {
                    ...
                    echo '<a class="nav-link" style="color: white;">Пользователь: ' . $data['user']->firstname . ' ' . $data['user']->lastname . '</a>';
                    echo '<a class="btn btn-outline-light my-2 my-sm-0" href="/logout">Выйти</a>';
                }
                ?>
            </div>
        </div>
